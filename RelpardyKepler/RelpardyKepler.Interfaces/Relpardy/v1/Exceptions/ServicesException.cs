...
namespace RelpardyKepler.Interfaces.Relpardy.v1.Exceptions
{
    // Note: Set the ExceptionIdentifier so that exceptions can be identified across namespaces.
    [ExceptionIdentifier("ef23918e-1718-47e9-a5a3-78ec961d5898")]
    [FaultCode(HttpStatusCode.NotFound)]
    public class ServicesException : ServiceException
    {
